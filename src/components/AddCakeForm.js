            ...
            <div className=" bg-dark add-cake-admin p-5 mt-5 container">
                ...
                <form onSubmit={handleOnSubmit}>
                    <div className="mb-3 row" >
                        <label htmlFor="formFile" className=" col-sm-2 col-form-label">Image Upload <span style={{color:"red"}}>*</span></label>
                    ...
                    <div className="mb-3 row">
                        <label htmlFor="cake_name" className="col-sm-2 col-form-label"> Cake Name <span style={{color:"red"}}>*</span></label>
                        <div className="col-sm-10">
                        <input type="text" className="form-control" id="cake_name" onChange={(e)=>{setCakeName(e.target.value)}} value={cakeName}/>
                        </div>
                    </div>
                    <div className="mb-3 row">
                        <label htmlFor="cake_desc" className="col-sm-2 col-form-label">Cake Description<span style={{color:"red"}}>*</span></label>
                        <div className="col-sm-10">
                        <input type="text" className="form-control" id="cake_desc" onChange={(e)=>{setCakeDesc(e.target.value)}} value={cakeDesc}/>
                        </div>
                    </div>
                    <div className="mb-3 row">
                        <label htmlFor="price" className="col-sm-2 col-form-label">Price<span style={{color:"red"}}>*</span></label>
                        <div className="col-sm-4">
                        <input type="number" className="form-control" id="price" value={cakePrice} onChange={(e)=>{setCakePrice(e.target.value)}}/>
                        </div>
                        <label htmlFor="weight" className="col-sm-2 text-center col-form-label">Weight<span style={{color:"red"}}>*</span></label>
                        <div className="col-sm-4">
                    ...
                    <div className="mb-3 row">
                        <label htmlFor="check" className="col-sm-2 col-check-label">EggLess</label>
                        ...
                        <label htmlFor="flavour" className="col-sm-2 text-center col-form-label">flavour<span style={{color:"red"}}>*</span></label>
                        <div className="col-sm-4">
                        <input type="text" className="form-control" id="flavour" value={cakeFlav} onChange={(e)=>{setCakeFlav(e.target.value)}}/>
                        </div>
                    </div>
                    <div className="mb-3 row">
                        <label htmlFor="flavour" className="col-sm-2  col-form-label">ingredients</label>
                        <button  type="button" className="btn btn-primary btn-sm col-sm-2 d-inline-block" style={{width:"33px",height:"33px"}} onClick={handleMinusClick} ><i className="fa fa-minus-square-o" aria-hidden="true"></i></button>
                        {cakeIngredients.map((x, i) => {
                            return  <div className="mb-3" style={{width:"443px"}}>
                            <input type="text"className="form-control" key={x} onChange={e => handleInputChange(e, i)} id="flavour" />
                            </div>;
                        })}
                        <button   type="button" className="btn btn-primary btn-sm col-sm-2 d-inline-block" style={{width:"33px",height:"33px"}} onClick={handlePlusClick} ><i className="fa fa-plus-square-o" aria-hidden="true"></i></button>
                    </div>
